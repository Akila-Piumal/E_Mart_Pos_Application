        ...
        >
          <div className="flex flex-col ml-3 mt-3 ">
            ...
            <div className="mt-5 flex flex-col gap-3">
              <div className="flex gap-4 hover:bg-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <p className="text-gray-500 hover:font-semibold hover:text-Orange1 hover:cursor-pointer">
                  Mobile Phones
                </p>
              </div>

              <div className="flex gap-4 mt-2 hover:bg-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
